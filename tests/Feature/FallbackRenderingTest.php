...
{
    #[Test]
    public function fallback_view_renders_for_an_http_exception(): void
    {
    ...
    #[Test]
    public function fallback_view_uses_locale_specific_copy(): void
    {
    ...
    #[Test]
    public function original_exception_headers_are_preserved(): void
    {
    ...
    #[Test]
    public function router_allow_header_is_preserved_via_method_not_allowed(): void
    {
